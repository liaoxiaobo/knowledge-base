...
![启动 Nginx 容器](../../assets/04-云原生与基础设施/4.7.3-nginx-web-01.jpeg)
...
![Nginx 默认欢迎页](../../assets/04-云原生与基础设施/4.7.3-nginx-web-02.png)

### 6.2 访问图片目录

`http://static.web.com:8080/img/` 列出图片文件：

![图片目录](../../assets/04-云原生与基础设施/4.7.3-nginx-web-03.png)

### 6.3 访问测试报告目录

`http://static.web.com:8080/robot-log/` 按日期列出测试报告：

![测试报告目录 1](../../assets/04-云原生与基础设施/4.7.3-nginx-web-04.png)

![测试报告目录 2](../../assets/04-云原生与基础设施/4.7.3-nginx-web-05.png)
...
![未压缩响应](../../assets/04-云原生与基础设施/4.7.3-nginx-web-07.jpeg)

请求头带 `Accept-Encoding: gzip,deflate` 时，响应头出现 `Content-Encoding: gzip`，表示压缩生效：

![压缩响应](../../assets/04-云原生与基础设施/4.7.3-nginx-web-06.png)
