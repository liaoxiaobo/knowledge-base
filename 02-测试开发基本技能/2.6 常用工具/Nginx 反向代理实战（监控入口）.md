...
![Grafana Dashboard](../../assets/04-云原生与基础设施/4.7.2-nginx-proxy-01.png)

- Alertmanager UI：`http://www.test.com:8081/alert/`

![Alertmanager UI](../../assets/04-云原生与基础设施/4.7.2-nginx-proxy-02.png)

- Prometheus UI：`http://www.test.com:8081/`

![Prometheus UI](../../assets/04-云原生与基础设施/4.7.2-nginx-proxy-03.png)
