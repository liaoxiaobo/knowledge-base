...
本文件为 Codex (Codex.ai/code) 提供在本仓库中工作的指导。
...
- 当用户想把零散素材整理成结构化知识库文章时，使用自定义 Codex Skill `.Codex/skills/knowledge-builder/SKILL.md`。
...
- `.Codex/settings.local.json` 包含针对常见重构操作的权限白名单。
