...
![node-exporter 部署成功](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-01.png)
...
![Prometheus UI](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-02.png)

![PromQL 查询](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-03.png)
...
![Grafana 配置数据源](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-04.png)

2. 导入社区 Dashboard，推荐使用 [Kubernetes cluster monitoring (via Prometheus)](https://grafana.com/dashboards/162)：

![导入 Dashboard](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-05.png)

3. 查看主机监控数据：

![主机监控数据](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-06.png)

4. 查看 Pod 和 Container 监控数据：

![Pod 和 Container 监控](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-07.png)
...
![kube-state-metrics 查询](../../assets/04-云计算领域测试/4.2.2-k8s-monitor-08.png)
